...
def train_kfold(model_name,df):
    ...
    for train, test in kfold.split(train_X, train_Y_index):
        ...
        print(train_weights)
        model.fit(train_X[train], train_YY, epochs=120, batch_size=5000, verbose=2,class_weight=train_weights,callbacks=[es,mc])
...
#all_models=['tetra_sc','tetra_sc_p','di','di_p','tri','tri_p','di_sc_p','tri_sc','tri_sc_p','all']
