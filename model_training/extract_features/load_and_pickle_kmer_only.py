...
pickle.dump(train_X_total[:,tetra_sc_end:], open( os.path.join(dump_data_dir,"tt_train.p"), "wb" ),protocol=4 )
...
pickle.dump(test_X_total[:,tetra_sc_end:], open( os.path.join(dump_data_dir,"tt_test.p"), "wb" ),protocol=4 )
